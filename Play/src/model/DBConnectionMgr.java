...
public class DBConnectionMgr {
    ...
    */
    ...
    //dbmysql properties 파일을 읽어들어서 키 값 불려오기
    public DBConnectionMgr() throws IOException{
    	Properties props = new Properties();
    	String file="C:/webtest/4.java/javastudy/Play/WebContent/WEB-INF/dbtest/dbmysql.properties";
    	
    	FileInputStream in = new FileInputStream(file);
       	props.load(in);//파일 메모리 불려오기
        in.close();
    	...
    	System.out.println("======DBConnectionMgr int=====");
    	System.out.println("driver "+_driver + " url "+_url);
    	System.out.println("user "+_user + " password "+_password);
    	System.out.println("======DBConnectionMgr end=====");
    }
